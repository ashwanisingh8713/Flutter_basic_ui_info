...
class ID_LableStyleError_0 extends StatelessWidget {
  const ID_LableStyleError_0({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const Center(
          child: ID_LableStyleError_0_Widget(),
        ),
      ),
    );
  }
...
class ID_LableStyleError_0_Widget extends StatelessWidget {
  const ID_LableStyleError_0_Widget({Key? key}) : super(key: key);
